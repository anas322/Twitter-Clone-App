                ...
                <div class="flex flex-col">
                    ...
                    <div class="flex items-center justify-between w-full px-2 py-1">
                        <div>
                            ...
                            <button
                                class="text-xs font-bold text-dim-600 p-2 rounded-full hover:bg-dim-300 focus:outline-none focus:ring-0 disabled:opacity-50"
                                disabled
                            >
                        ...
                        <div>
                            <button
                                :disabled="loading || !tweetContent"
                                @click="handleSubmit"
                                class="px-3 py-1 font-medium text-white bg-blue-500 rounded-full hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition duration-300 disabled:opacity-50"
                            >
                                Tweet
                            </button>
                        </div>
...
const handleSubmit = async () => {
    ...
    if (selectedImage.value?.length > 0) {
        for (let i = 0; i < selectedImage.value.length; i++) {
            formData.append("selectedImage[]", selectedImage.value[i]);
        }
    }
